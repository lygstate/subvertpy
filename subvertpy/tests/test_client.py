...
""").splitlines(), outf.read().splitlines())
    ...
    def assertLogEntryChangedPathsEquals(self, expected, entry):
        ...
        self.assertEquals(sorted(expected), sorted(list(iterkeys(changed_paths))))
    ...
    def test_info(self):
        ...
        self.assertEquals(["foo"], list(iterkeys(info)))
